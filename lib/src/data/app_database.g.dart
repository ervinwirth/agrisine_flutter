...
class $FieldsTable extends Fields with TableInfo<$FieldsTable, Field> {
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [id, projectId, name, area, createdAt, updatedAt, isDeleted];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class Field extends DataClass implements Insertable<Field> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, projectId, name, area, createdAt, updatedAt, isDeleted);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Field &&
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  @override
  List<DatabaseSchemaEntity> get allSchemaEntities => [projects, fields];
}
...
final class $$ProjectsTableReferences
  ...
  static MultiTypedResultKey<$FieldsTable, List<Field>> _fieldsRefsTable(
          _$AppDatabase db) =>
      MultiTypedResultKey.fromTable(db.fields,
          aliasName: $_aliasNameGenerator(db.projects.id, db.fields.projectId));
...
class $$ProjectsTableTableManager extends RootTableManager<
    ...
    Project,
    PrefetchHooks Function({bool fieldsRefs})> {
  $$ProjectsTableTableManager(_$AppDatabase db, $ProjectsTable table)
      : super(TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: ({fieldsRefs = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [if (fieldsRefs) db.fields],
              addJoins: null,
                ...
                return [
                  if (fieldsRefs)
                    await $_getPrefetchedData(
                        currentTable: table,
                        referencedTable:
                            $$ProjectsTableReferences._fieldsRefsTable(db),
                        managerFromTypedResult: (p0) =>
                            $$ProjectsTableReferences(db, table, p0).fieldsRefs,
...
final class $$FieldsTableReferences
  ...
  static $ProjectsTable _projectIdTable(_$AppDatabase db) => db.projects
      .createAlias($_aliasNameGenerator(db.fields.projectId, db.projects.id));
              ...
              addJoins: <
                ...
                if (projectId) {
                  state = state.withJoin(
                    ...
                    referencedTable:
                        $$FieldsTableReferences._projectIdTable(db),
                    referencedColumn:
                        $$FieldsTableReferences._projectIdTable(db).id,
                  ) as T;
                }
